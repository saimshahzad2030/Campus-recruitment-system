...
const UserDetails = () => {
  ...
  return (
    <>
      ...
      <div
        className="bg-gray-700 py-12"
        style={{ display: formSubmitted ? "none" : "" }}
      >
        <h1
          className={`text-4xl font-bold mb-12 text-center text-gray-50 ${style.heading}`}
        >
          Student Info
        </h1>
      ...
      <div
        className="flex flex-col items-center bg-gray-700 w-full"
        style={{ display: formSubmitted ? "" : "none" }}
      >
        <div className={` py-8 w-full`}>
          <h1
            className={`text-3xl sm:text-5xl font-bold mb-12 text-center w-full text-gray-50 ${style.heading}`}
          >
            {data.firstname !== undefined ? data.firstname : firstname}{" "}
            {data.lastname !== undefined ? data.lastname : lastname}{" "}
          </h1>
          <div className={`grid grid-cols-1 sm:grid-cols-2  w-full`}>
            <div className={`flex flex-col align-start  m-4`}>
              <h1
                className={`text-3xl font-bold  pl-4 text-gray-50 ${style.subHeading}`}
              >
                Age
              </h1>
              <div className={`flex flex-col align-start bg-gray-50 my-4 pl-4`}>
                <p className={`py-4 text-md ${style.subHeadingText}`}>
                  I am {data && data.age !== undefined ? data.age : age} years
                  old.
                </p>
              </div>
            </div>
            <div className={`flex flex-col align-start  m-4`}>
              ...
              <div className={`flex flex-col align-start bg-gray-50 my-4 pl-4`}>
                <p className={`py-4 text-md ${style.subHeadingText}`}>
                  ...
                  {data.faculty !== undefined ? data.faculty : faculty} faculty.
                </p>
              </div>
            </div>
            ...
            <div className={`flex flex-col align-start  m-4`}>
              ...
              <div className={`flex flex-col align-start bg-gray-50 my-4 pl-4`}>
                <p className={`py-4 text-md ${style.subHeadingText}`}>
                  I am a passionate about my role of{" "}
            ...
            <div className={`flex flex-col align-start  m-4`}>
              ...
              <div className={`flex flex-col align-start bg-gray-50 my-4 pl-4`}>
                <p className={`py-4 text-md ${style.subHeadingText}`}>
                  I have{" "}
                  {data.experience !== undefined ? data.experience : experience}{" "}
