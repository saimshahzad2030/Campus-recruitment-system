            ...
            <nav className={` sticky  top-0 left-0 w-full bg-gray-100 p-4 2xl:p-4 xl:p-4 lg:p-4 z-10 transition-all duration-300 ease-in-out`}>
                <div className={`flex items-center justify-between `}>
                    <div className={`flex items-center justify-between flex-shrink-0 sm:w-full lg:w-full 2xl:w-full  `}>
                        ...
                        <div className={`hidden sm:flex flex-grow flex flex-row items-center justify-end space-x-4 sm:space-x-3 lg:space-x-2 2xl:space-x-3 2xl:ml-4 xl:ml-4 lg:ml-4 md:ml-2 sm:ml-1`}>
                          ...
                          <button className="text-md sm:text-md bg-red-500 text-gray-50 font-bold py-1 px-1 sm:py-1 sm:px-1 md:py-2 md:px-2 rounded focus:outline-none focus:shadow-outline hover:bg-red-600"
