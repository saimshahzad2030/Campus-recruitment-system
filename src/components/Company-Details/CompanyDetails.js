...
import { addJob, updateJob } from "@/utils/functional-utils/jobs-utils";
...
const SuspenseFunction = () => {
  ...
  const [job, setJob] = useState(
    params.get("position") === undefined ? "" : params.get("position")
  );
  const [experience, setExperience] = useState(
    params.get("experience") === undefined ? "" : params.get("experience")
  );
  const [location, setLocation] = useState(
    params.get("location") === undefined ? "" : params.get("location")
  );
  const [typeOfEmployment, setTypeOfEmployment] = useState(
    params.get("availability") === undefined ? "" : params.get("availability")
  );
  const [message, setMessage] = useState(
    params.get("companymessage") === undefined
      ? ""
      : params.get("companymessage")
  );
